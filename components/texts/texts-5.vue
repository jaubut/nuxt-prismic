<template>
  <div class="container">
    <div class="border-bottom mb-2 mb-md-4">
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a class="text-dark" href=""><span>First</span></a>
        </li>
        <li class="breadcrumb-item">
          <a class="text-dark" href=""><span>Second</span></a>
        </li>
      ...
      <div class="col-12 col-md-3">
        <div class="navbar-nav weight-500">
          ...
          <div class="navbar-nav pl-2 small weight-500">
            ...
            <div class="nav-item">
              <a class="nav-link text-dark" href="">Overview</a>
            </div>
            <div class="nav-item">
              <a class="nav-link text-dark" href="">Contents</a>
            </div>
          </div>
          <div class="nav-item">
            <a class="nav-link text-dark" href="">Overview</a>
