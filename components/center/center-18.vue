    ...
    <div class="py-5">
      <div class="row justify-content-center text-center mb-4">
        <div class="col-12 col-md-8 col-lg-6">
          ...
          </p><a class="large weight-500 action-link" href=""><span>Link</span></a>
        </div>
      </div>
      <div class="images-ratio ratio-3-1 w-100 mb-3" style="background-image: url(@/assets/pictures/image-1110x410.png)">
