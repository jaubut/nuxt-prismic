<template>
  <div class="container">
    <div class="d-flex justify-content-around pt-5 mb-4">
      <div class="nav nav-tabs weight-500">
        <div class="nav-item">
        ...
        <div class="card shadow-sm h-100">
          <div class="card-body d-flex flex-column">
            <div>
              ...
              <div class="price-medium mb-4">
                $20<span class="price-unit">/ month</span>
              </div>
        ...
        <div class="card shadow-sm h-100">
          <div class="card-body d-flex flex-column">
            <div>
              ...
              <div class="price-medium mb-4">
                $29<span class="price-unit">/ month</span>
              </div>
              <p>By creating an Account on our service, you agree to subscribe</p>
              <ul class="mb-4">
                <li>Showcase and embed your work</li>
        ...
        <div class="card shadow-sm h-100">
          <div class="card-body d-flex flex-column">
            <div>
              ...
              <div class="price-medium mb-4">
                $79<span class="price-unit">/ month</span>
              </div>
              <p>By creating an Account on our service, you agree to subscribe</p>
              <ul class="mb-4">
                <li>Showcase and embed your work</li>
