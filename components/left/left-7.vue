    ...
    <div class="row justify-content-between align-items-center py-5">
      ...
      <div class="col-12 col-md-6 order-1 order-md-2 pl-md-0 mb-4 mb-md-0">
        <div class="swiper has-outside-pagination">
          <div id="slider-left-7" class="swiper-container">
          ...
          <div id="slider-left-7-pagination" class="swiper-pagination swiper-pagination-outside" /><a id="slider-left-7-prev" class="carousel-control-prev" href="">
            <div class="carousel-control-prev-icon" />
          </a><a id="slider-left-7-next" class="carousel-control-next" href="">
