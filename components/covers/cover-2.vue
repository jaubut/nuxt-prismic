        ...
        <div class="col-12 col-md-5 order-2 order-md-1">
          ...
          <div class="row align-items-center">
            <div class="col-12 col-md-5 mb-2 mb-md-0">
              <a class="btn btn-block btn-lg btn-primary" href="">Action</a>
            </div>
            <div class="col-12 col-md-7 text-center text-md-left">
              <div class="small ml-md-6">
                Separated they live in Books,<br>but sometimes.&nbsp;<a class="text-white" href=""><span>Learn more</span></a>
              </div>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-6 order-1 order-md-2 pl-md-0 mb-4 mb-md-0">
          <img class="w-100" src="@/assets/pictures/cover-2.png">
        </div>
      </div>
    </div>
  </div>
